"""
Module for Qlearning algorithm.
"""
...
from ..utils.data_structures import Transition, QLearningParams
...
class QLearningAgent:
    ...
    def update(self, transition: Transition) -> None:
        ...
        delta = (
            transition.reward
            + self.params.gamma * np.max(self.q_values[transition.next_state]) * (1 - transition.done)
